#Define four Python functions named run, swing, slide, 
#and hide_and_seek. Each function should take
#varying number of children's names as the argument.

#For example, the run function would 
#be defined as follows:

#def run(*kids):
    # Loop through all the kids and print that the 
    # child performed the activity.
...
def swing(*kids):
    for kid in kids:
        print(f"{kid} is swinging high!")
        
def slide(*kids):
    for kid in kids:
        print(f"{kid} is sliding fast!")

def hide(*kids):
    for kid in kids:
        print(f"{kid} is hiding like a champ.")
